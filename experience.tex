\job
  ...
  {\begin{achievements}
    \item Led ideation, selling, and building of solutions for a public sector non-profit that helped government agencies achieve their policy objectives in domains such as workforce development, wage and hour, unemployment, and public safety
    \item Secured \$17.1M of revenue (\$3.2M in philanthropic grants, \$3.0M in partner support funding, and \$10.9M in government contracts) through relationship-building with policy and IT executive stakeholders, technical proposal writing, and implementation of demonstrable prototypes
    \item Championed using build partners for collaborative pursuit of new opportunities and elastic scaling up to 3x of development capacity; developed relationships across diverse vendors such as large ISVs, cloud providers, and small development shops to best match resources to project needs
    ...
    \item Drove engineering excellence by developing a robust hiring process, establishing estimation and project cost tracking methodologies, improving CI/CD approaches (achieving full deployment automation), leading company-wide certification and training initiatives, and mentoring technical leaders
  \end{achievements}}
...
\job
  ...
  {\begin{achievements}
    ...
    \item Developed, documented, and drove adoption of a suite of internal automation tools used by dozens of teams Amazon-wide, saving the company over \$10M annually
  \end{achievements}}
