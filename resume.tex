...
\skill{Coding}
  {Python, Node.js, TypeScript, JavaScript, Java, C, C++, C\#, Perl, Bash}

\skill{Tech}
  {React.js, FastAPI, Docker, Kubernetes, AWS, GovCloud, GCP}

\skill{Data}
  {MySQL, PostgreSQL, MongoDB, Cassandra, Elasticsearch, BigQuery}

\skill{Tools}
  {GitHub, Gitlab, Jira, Confluence, Markdown, Helm, Terraform, CDK}
