\project
  ...
  {\begin{achievements}
    \item Built an application suite implementing a governor's strategic workforce initiative, serving 2M constituents
    ...
    \item Designed system architecture and for unemployment insurance applications and built features such as an automated work-search tracking tool in Amazon Connect and an API wrapper for the mainframe system of record; enabled the state to better serve claimants with limited mobile devices and poor connectivity
